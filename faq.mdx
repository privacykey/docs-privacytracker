...
<AccordionGroup>
  ...
  <Accordion title="Is the desktop app open source?" icon="code">
    Yes. The Tauri shell (`src-tauri/`), the Next.js bundle, the iPhone import helper (`tools/ios-app-import/`), and everything else in the repo is Apache-2.0 licensed. The signed binaries we publish on GitHub releases are built deterministically from the same source — you can build your own from `develop/build-from-source` if you want to verify.
  </Accordion>
</AccordionGroup>
