...
<Note>
  If you'd rather track their device in your own install, record them as its owner — when you import it, or on **Settings → Devices** — and use the [device menu](/devices#the-device-menu) to switch between your apps and theirs. Removing apps from their device also asks you to [confirm you have their permission](/devices#confirming-you-have-permission).
</Note>
